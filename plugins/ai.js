const {
  ...
  smd(
    ...
    async (message, input) => {
      try {
        ...
        return await message.send(`*QUEEN_BHAD-DC ʙᴀʀᴅ ᴀɪ:*\n ${result}`, { quoted: message });
      } catch (error) {
  ...
  smd({
    ...
    try {
      ...
      const { result } = res;
      const astro = "QUEEN_BHAD-DC ɢᴇᴍɪɴɪ ᴀɪ"
      const tbl = "```";
      ...
      try {
        if (
          ...
          if (
            ...
            _0x2dfb59[0].includes("QUEEN_BHAD-DC • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            ...
            try {
              if (_0x2ecd2a) {
                ...
                if (_0x13a11c.toLowerCase().startsWith("reply")) {
                  ...
                  let _0x3f6b59 =
                    "*QUEEN_BHAD-DC • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
