  ...
  async (message, args) => {
    try {
      ...
      if (url.toLowerCase().includes("https")) {
        ...
        return await message.send("`QUEEN_BHAD-DC- UPDATE WAS SUCCESSFULL ✅`");
      } else {
...
${menuThemeFooter}                         
*┌┤✑  Thanks for Choosing QUEEN_BHAD-DC
│└────────────┈ ⳹        
│*©2024-2099 BADBOI HACKER*
└─────────────────┈ ⳹*
${readmore}`;
  ...
  async (_0x22514a) => {
    try {
      let _0x20ed34 = (
        ...
        "/" +
        formatp(os.totalmem()) +
        "\n\n *🧑‍💻 :*  QUEEN_BHAD-DC ɪꜱ ɴᴏᴡ Aᴠᴀɪʟᴀʙʟᴇ\n\n" +
        readmore +
        "\n╭──❰ *ALL MENU* ❱\n│🏮 Lɪꜱᴛ\n│🏮 Cᴀᴛᴇɢᴏʀʏ\n│🏮 Hᴇʟᴘ\n│🏮 Aʟɪᴠᴇ\n│🏮 Uᴘᴛɪᴍᴇ\n│🏮 Wᴇᴀᴛʜᴇʀ\n│🏮 Lɪɴᴋ\n│🏮 Cᴘᴜ\n│🏮 Rᴇᴘᴏꜱɪᴛᴏʀʏ\n╰─────────────⦁"
      ).trim();
    ...
    try {
      ...
      const designs = [
        async () => {
          ...
          const captionText = `QUEEN_BHAD-DC 1.𝟶.𝟶 ᴘᴀᴛᴄʜ\n\n*Ping:* ${pingSeconds} seconds${quoteText}\n\nQUEEN_BHAD-DC`;
...
smd(
  ...
  async (m) => {
    try {
      ...
      const message = `*QUEEN_BHAD-DC ʀᴜɴɴɪɴɢ sɪɴᴄᴇ:* ${uptimeHours}h ${uptimeMinutes}ᴍ ${uptimeSeconds}s\n \t_ʜᴇʀᴇ's ᴍᴏʀᴇ ɪɴғᴏ_\n*ʀᴀᴍ ᴜsᴀɢᴇ:* ${ramUsage.toFixed(2)} MB\n*ᴄᴘᴜ ɴᴀᴍᴇ:* ${cpuModel}`;
      const contextInfo = {
        isForwarded: true,
        forwardingScore: 999,
        title: "QUEEN_BHAD-DC Running Since",
        body: message,
        footerText: "QUEEN_BHAD-DC 2024",
    ...
    try {
      ...
      if (!isNaN(_0x56b5d3)) {
        if (
          ...
          _0x1eb88a[1][_0x210c92(362)]("QUEEN_BHAD-DC_FANCY_TEXT")
        ) {
