     ...
     try {
       ...
       for (let i = startIndex - 1; i < endIndex; i++) {
         ...
         if (isSticker) {
           ...
           await message.reply(
             sticker,
             { packname: Config.packname, author: "QUEEN_ANITA-V2" },
             "sticker"
           );
         } else {
     ...
     try {
       ...
       if (!_0x1c586e) {
         return await _0x1ae8f8.reply(
           "*Provide Repo Url, _.gitclone https://github.com/DeeCeeXxx/Queen_Anita-V2_*"
         );
       }
       const _0x5906ab =
...
smd({
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       let _0x4b47c3 = "./temp/QUEEN_ANITA-V2 " + _0x1d542b[1] + ".mp3";
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     } else if (_0x5b8ee5[0].includes("QUEEN_ANITA-V2 • APK DOWNLOADER")) {
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x452f00 = _0x5c3baf.title || _0x57ada1 || _0x13f167[0x1] || "QUEEN_ANITA-V2 -- YT Video";
      if (_0x57ada1) {
