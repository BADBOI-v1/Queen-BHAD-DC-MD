let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `QUEEN_BHAD-DC 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VadCyFZGufJ2YW4bG42x\n\n ${Config.botname} *©BADBOI HACKER*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*QUEEN_BHAD-DC CURRENTLY ACTIVE!*";
