,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
Typed *surrender* to surrender and admited defeat`
  ...
  david: `That's my creator name 😊 ,Thank you for using a bot from him...`,
  cyril: `That's my Creator name ,Thank you for using a bot from him 🤗 ...`,
  fred: `I am busy,will reply you when I feel like (¬_¬)ﾉ...`,
...
📞 For inquiries, Taira Makino at +2349066528353
  ...
  case 'setprefix': {
	...
	case 'sc': case 'script': case 'repo': case "link": {
        ...
        try {
          ...
          let { data } = await axios.get('https://api.github.com/repos/DeeCeeXxx/Queen_Anita-V2');
          let teks = `QUEEN_ANITA-V2 WHATSAPP-BOT*\n\n*Total Stars*: ${data.stargazers_count}⭐\n*Total Forks*: ${data.forks_count} forks\n*GitHub*: github.com/DeeCeeXxx/Queen_Anita-V2\n\nDon't forget to follow me on *GitHub* and give a ⭐️ to my projects.`;
              ...
              message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                  ...
                  header: proto.Message.InteractiveMessage.Header.create({
                    title: "©2024-2099 David Cyril",
                    subtitle: "QUEEN_ANITA-V2 WHATSAPP-BOT",
                  ...
                  nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                    buttons: [
                      {
                        "name": "cta_url",
                        "buttonParamsJson": "{\"display_text\":\"Repository\",\"url\":\"https://github.com/DeeCeeXxx/Queen_Anita-V2\",\"merchant_url\":\"https://github.com/DeeCeeXxx/Queen_Anita-V2\"}"
                      }
                    ]
                  })
                })
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                  ...
                  nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                    buttons: [
                      {
                        "name": "cta_url",
                        "buttonParamsJson": "{\"display_text\":\"Repo🔗\",\"url\":\"https://github.com/DeeCeeXxx/Queen_Anita-V2\",\"merchant_url\":\"https://github.com/DeeCeeXxx/Queen_Anita-V2\"}"
                      },
		      {
                        "name": "cta_url",
                        "buttonParamsJson": "{\"display_text\":\"Channel📍 \",\"url\":\"https://whatsapp.com/channel/0029VaeRru3ADTOEKPCPom0L\",\"merchant_url\":\"https://whatsapp.com/channel/0029VaeRru3ADTOEKPCPom0L\"}"
		      },
		      {
                        "name": "cta_url",
                        "buttonParamsJson": "{\"display_text\":\"David Cyril👑\",\"url\":\"https://wa.me/2349066528353\",\"merchant_url\":\"https://wa.me/2349066528353\"}"
		      },
                    ]
                  })
                })
    ...
    `;
      ...
      case 'ip':
        ...
        getServerIp()
          .then(serverIp => {
            if (serverIp) {
              const message = `QUEEN_ANITA-V2 Server Address is: ${serverIp}`;
              Taira.sendMessage(from, { text: message }, { quoted: m });
            } else {
...
//REACTIONS
	...
	case 'emix': case 'emojimix': {
      ...
      case 'getcase':
        if (isBan) return reply(mess.banned);
        if (m.sender != '2349066528353@s.whatsapp.net') { return; }
        ...
        const getCase = (cases) => {
          return "case" + `'${cases}'` + fs.readFileSync("QUEEN_ANITA-V2.js").toString().split('case \'' + cases + '\'')[1].split("break;")[0] + "break;"
        }
        reply(`${getCase(q)}`)
        break;
      ...
      case 'addcase': {
        ...
        fs.readFile('./QUEEN_ANITA-V2.js', 'utf8', (err, data) => {
          if (err) {
            console.error('Error reading QUEEN_ANITA-V2.js:', err);
          ...
          fs.writeFile('./QUEEN_ANITA-V2.js', newData, 'utf8', (err) => {
            if (err) {
              console.error('Error writing to QUEEN_ANITA-V2.js:', err);
  ...
  👉 Following : ${gitdata.following}`
      ...
      case 'gitclone':
        ...
        if (!args[0]) {
          return reply(`Please provide the GitHub repository link.\nExample:\n${prefix}${command} https://github.com/DeeCeeXxx/QUEEN_ANITA-V2`);
        }
      ...
      case 'banchat': case 'bangroup': case 'banmode': {
        ...
        if (args[0] === "on") {
          if (isBanChat) return reply('This Group is Already Banned from using QUEEN_ANITA-V2');
          banchat.push(from);
          reply('This Group has been banned from using QUEEN_ANITA-V2!');
          ...
          reply('This Group has been *unbanned* from using QUEEN_ANITA-V2!');
        } else {
...
*Message : ${text}*\n\n`
	...
	case 'unmute': case 'unmutegc': {
      ...
      case "tts": case "texttospeech": case "say": case "speak": {
        ...
        Taira.sendMessage(m.chat, { audio: { url: texttospeechurl, }, mimetype: "audio/mpeg", fileName: `ANITASpeech.mp3`, }, { quoted: m, });
      }
        break;
      ...
      case 'ytvd': case 'video': case 'ytvideo': case 'ytmp4': {
        ...
        Taira.sendMessage(from, { video: { url: ytmp4play.videoUrl }, mimetype: "video/mp4", caption: anu.title + ' By *QUEEN_ANITA-V2*', }, { quoted: m })
      }
      ...
      caption: `「  QUEEN_ANITA-V2 Youtube Downloader  」
      ...
      */
      ...
      case 'ytmp3': {
        ...
        await Taira.sendMessage(from, { document: fs.readFileSync(ytmp3play2.path), fileName: 'QUEEN_ANITA-V2_YTmp3_Downloader.mp3', mimetype: 'audio/mpeg', }, { quoted: m })
      }
        break;
      ...
      case 'ytvd2': case 'ytmp4': {
        ...
        Taira.sendMessage(from, { video: { url: ytmp4play2.videoUrl }, mimetype: "video/mp4", caption: 'Downloaded by *QUEEN_ANITA-V2*', }, { quoted: m })
      }
        break;
      ...
      case 'swm': case 'take': case 'stickerwm': case 'steal': {
        ...
        if (!args.join(" ")) return reply(`use -take QUEEN_ANITA-V2|By: David Cyril`)
        const swn = args.join(" ")
      ...
      case 'sgif': case 'sticker': case 's': {
        ...
        if (/image/.test(mime)) {
          let media = await quoted.download()
          let encmedia = await Taira.sendImageAsSticker(m.chat, media, m, { packname: 'QUEEN_ANITA-V2', author: global.author })
          await fs.unlinkSync(encmedia)
        } else if (/video/.test(mime)) {
          if ((quoted.msg || quoted).seconds > 11) return reply('Maximum 10 seconds!')
          let media = await quoted.download()
          let encmedia = await Taira.sendVideoAsSticker(m.chat, media, m, { packname: 'QUEEN_ANITA-V2', author: global.author })
          await fs.unlinkSync(encmedia)
        } else {
      ...
      case 'handsomecheck':
        ...
        if (isBanChat) return reply(mess.bangc);
        Taira.sendMessage(from, { react: { text: "😺", key: m.key } })
        if (!text) return reply(`Tag Someone, Example : ${prefix + command} @David`)
...
┃   *RAM*  : *${formatp(os.totalmem() - os.freemem())} / ${formatp(os.totalmem())}*
┃   ⌯CPU* : *${totalCpuUsage}%*
┃   *Developer* : *DAVID CYRIL*
┃
✦•······················•✦•······················•✦
┌┤✑  Thanks For QUEEN_ANITA-V2
│└────────────┈ ⳹        
...
╰════════════════ ⪨`;
            ...
            viewOnceMessage: {
              message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                  ...
                  header: proto.Message.InteractiveMessage.Header.create({
                    ...(await prepareWAMessageMedia({ image: { url: 'https://i.imgur.com/H4qeXwa.jpeg' } }, { upload: Taira.waUploadToServer })),
                      ...
                      },
	              {
                      ...
                      {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"Channel 📰","url":"https://whatsapp.com/channel/0029VaY0Zq32P59piTo5rg0K","merchant_url":"https://whatsapp.com/channel/0029VaeRru3ADTOEKPCPom0L"}`
                      },
                      {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"David Cyril 🫡","url":"https://wa.me/2349066528353","merchant_url":"https://wa.me/2349066528353"}`
      ...
      case '':
        if (isCmd) {
          ...
          reply(`Hi ${pushname}👋 ,I am QUEEN_ANITA-V2 Developed By David Cyril. Do You Need Any Help ?`)
        }
...
if (stdout) return m.reply(`${stdout}`)
    ...
    Taira.sendMessage('2349066528353@s.whatsapp.net', util.format(err), { quoted: m })
    console.log(err)
    let e = String(err)
